...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
	...
	public int registerBeanDefinitions(Document doc, Resource resource) throws BeanDefinitionStoreException {
		// 1.使用 DefaultBeanDefinitionDocumentReader 实例化 BeanDefinitionDocumentReader接口
		BeanDefinitionDocumentReader documentReader = createBeanDefinitionDocumentReader();
		// 2.设置环境变量
		documentReader.setEnvironment(this.getEnvironment());
		// 3.1 getRegistry() 在实例化 XmlBeanDefinitionReader 
		//        传入了BeanDefinitionRegistry,一般在开中会使用的是DefaultListableBeanFactory
		// 3.2 
		// xw添加start
		BeanDefinitionRegistry bean = getRegistry();
		// xw添加end 
